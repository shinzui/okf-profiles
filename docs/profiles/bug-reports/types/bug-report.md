...
title: Bug Report
description: One wrong behavior, in something this repository already provides, with
  one reproduction.
generated:
...
Declared by the [bug-reports](/profile.md) profile.
...
- Schema columns: none
- Document ID prefix: `BUG`

## Frontmatter rules

Every rule below is the effective rule for a concept of type `Bug Report`:
