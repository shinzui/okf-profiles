...
title: Assessable Pattern
description: 'A catalog pattern promoted to an assessable contract: stable PAT handle,
...
Every rule below is the effective rule for a concept of type `Assessable Pattern`:
