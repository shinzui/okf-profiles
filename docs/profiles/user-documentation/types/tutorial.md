...
title: Tutorial
description: A learning-oriented sequence that helps a reader gain initial working
  experience.
generated:
...
Every rule below is the effective rule for a concept of type `Tutorial`:
