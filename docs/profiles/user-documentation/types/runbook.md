...
title: Runbook
description: An operational procedure whose ordering, safety conditions, and recovery
  behavior matter.
generated:
...
Every rule below is the effective rule for a concept of type `Runbook`:
