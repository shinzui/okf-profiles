...
title: Explanation
description: Conceptual material that builds understanding, context, and decision-making
  judgment.
generated:
...
Every rule below is the effective rule for a concept of type `Explanation`:
