...
title: Reference
description: Authoritative lookup material describing interfaces, contracts, options,
  or current state.
generated:
...
Every rule below is the effective rule for a concept of type `Reference`:
