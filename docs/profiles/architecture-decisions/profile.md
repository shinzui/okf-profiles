...
description: Flat repository-owned architecture decisions with stable ADR handles.
generated:
...
- [Architecture Decision Record](/types/architecture-decision-record.md) — A durable record of one architecture decision and its rationale.
