...
title: Event Stream
description: One logical event-sourcing aggregate category.
generated:
...
Every rule below is the effective rule for a concept of type `Event Stream`:
