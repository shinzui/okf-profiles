---
type: OKF Profile
title: tan-postgresql
description: Tan PostgreSQL conventions, including table roles and logical event streams.
generated:
...
- [PostgreSQL Table](/types/postgresql-table.md) — One physical table classified by derivation, lifecycle, and domain role.
- [PostgreSQL View](/types/postgresql-view.md) — One view and the columns it projects.
- [Event Stream](/types/event-stream.md) — One logical event-sourcing aggregate category.
