...
- [Add a shared terminology profile](add-a-shared-terminology-profile.md) - Publish documentation.terminology, a profile for controlled project vocabularies with stable TERM-N handles, preferred and discouraged wording, typed term relations, cross-project equivalence, succession, and code anchors, plus an adopt-terminology blueprint.
