...
`coordination.improvementRequests` older than v0.18.0, change only the imported tag to v0.18.0,
...
0.9.0.0 cannot load the v0.18.0 descriptor, whose schema adds optional `guidance`. If the
