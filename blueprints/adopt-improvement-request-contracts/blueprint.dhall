...
in  S.Blueprint::{
    ...
    , files =
      [ S.Blueprint.BlueprintFile::{
        ...
        , description = Some
            "The structured dependency and acceptance-criterion contract introduced in v0.12.0, safe promotion rules, the v0.17.0 descriptor pin, and validation commands."
        }
      ]
