...
local profile descriptors, and validation commands. It can repin a shared descriptor to v0.18.0
...
- the released `okf-profiles` v0.18.0 catalog (the structured fields were introduced in v0.12.0);
