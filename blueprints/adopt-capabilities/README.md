...
The shipped descriptor pins okf-profiles **v0.18.0**, which requires **`okf` 0.9.0.0 or later** to
load. The capability contract itself was introduced in v0.9.0 and is unchanged since; v0.18.0 only
