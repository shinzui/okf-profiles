...
description: This record never says what the review concluded.
generated:
  by: human:nadeem
...
`outcome` is absent. Without it the record proves an examination happened and
withholds the only thing a reader wanted from it.
