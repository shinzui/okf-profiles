...
description: This record records an outcome outside the vocabulary.
generated:
  by: human:nadeem
...
`lgtm` is not comparable across repositories, and it is ambiguous besides — it
is written both for `approved` and for `commented`.
